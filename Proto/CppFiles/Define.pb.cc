...
#include "ProtoFiles/Define.pb.h"
...
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_ProtoFiles_2fDefine_2eproto[2];
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_ProtoFiles_2fDefine_2eproto = nullptr;
const ::uint32_t TableStruct_ProtoFiles_2fDefine_2eproto::offsets[1] = {};
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_ProtoFiles_2fDefine_2eproto = {
    ...
    TableStruct_ProtoFiles_2fDefine_2eproto::offsets,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_ProtoFiles_2fDefine_2eproto),
         ::std::false_type{});
